...
export const coursesData: CourseDetail[] = [
  {
    ...
    tabs: [
      ...
      },
      {
        ...
        aboutTitle: "About Program",
        aboutDescription:
          "The Intermediate in Commerce (I.Com) program is designed for students who want to build a strong foundation in commerce, accounting, business, economics, and finance. It prepares students for higher studies in business, accounting, banking, management, and related professional fields. Smart Study Center provides concept-based teaching, regular assessments, exam preparation, past-paper practice, and individual guidance to help students achieve strong academic results. Morning and Evening classes are available for both Regular and Private students.",
        duration: "6 Months (Part I & Part II)",
        eligibility: "Matriculation (Science or Arts / General).",
        keySubjects: [
          "Principles of Accounting (Part I & II)",
          "Principles of Economics (Part I)",
          "Principles of Commerce (Part I)",
          "Business Mathematics (Part I)",
          "Commercial Geography (Part II)",
          "Banking (Part II)",
          "Business Statistics (Part II)",
          "English, Urdu, Islamic Studies & Pakistan Studies",
        ],
        documentsRequired: [
          "Matriculation / 10th Class Result Card or Mark Sheet",
          "Copy of Student CNIC / B-Form",
          "Copy of Parent / Guardian CNIC",
          "1 Recent Passport Size Photographs",
        ...
        highlights: [
          "I.Com Part I: Accounting, Economics, Commerce, Business Mathematics, English, Urdu & Islamic Studies",
          "I.Com Part II: Accounting, Commercial Geography, Banking, Business Statistics, English, Urdu & Pakistan Studies",
          "Concept-based teaching with individual attention for every student",
          "Regular assessments and past-paper practice for board exam readiness",
          "Ideal pathway for careers in Banking, Accounting, Business & Finance",
        ],
      },
    ],
  },
